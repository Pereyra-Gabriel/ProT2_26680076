<div class="row row-cols-1 row-cols-md-2 g-4">
  <div class="col">
    <div class="card">
      <img src="assets/img/producto_1" class="card-img-top" alt="">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="assets/img/producto_2" class="card-img-top" alt="...">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="assets/img/producto_3" class="card-img-top" alt="...">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="assets/img/producto_4" class="card-img-top" alt="...">
      <div class="card-body">
